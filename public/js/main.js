...
//       // "Flip" the card by adding the clip class, this triggers an animation
//       this.classList.add("flip");

//       // Find the front face image of the clicked card and returns the src value
//       const imgSrc = this.querySelector(".front_face").getAttribute("src");
...
//       // If the two cards images are the same remove click listeners so they can't be flipped again
...
// function checkMatch() {
//   // Store the cards the user clicks
//   let firstCard = undefined;
//   let secondCard = undefined;

//   // Adds a click listener function
//   $(".card").on("click", function () {
//     // this is the card the user selects
//     // toggleClass("flip") adds.flip if its missing or removes if it already exists
//     $(this).toggleClass("flip");

//     // If the first card is null
//     // $(this): clicked card div
//     // find: finds the Pokemon image inside that card (returns jQuery)
//     // [0]: extracts the raw HTML element
//     // so firstCard stores the image element for the first selected Pokemon
//     if (!firstCard) firstCard = $(this).find(".front_face")[0];
//     else {
//       // Same thing if the user selects the second card
//       secondCard = $(this).find(".front_face")[0];

//       console.log(firstCard.src, secondCard.src);

//       if (firstCard && $(this)[0] === firstCard.card[0]) {
//         console.log("double click");
//         return;
//       }
//       // If the image is the same for both cards it is a match
...
//         // Waits 1 second then flips the cards back over
//         setTimeout(() => {
